...
$min_price = 11; // Giá sản phẩm tối thiểu
$max_price = 13; // Giá sản phẩm tối đa
                ...
                <form method="POST" action="productdetail.php">
                    ...
                    <div class="block2-txt flex-w flex-t p-t-14">
                        <div class="block2-txt-child1 flex-col-l">
                            <input class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" style="background-color: white;"
                                type="submit" name="p_name" value="<?php echo $product["p_name"]; ?>">
                            <input type="hidden" name="user" value="<?php echo $userLogin["userName"]; ?>">
                            <p class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6 text1"><?php echo $product['p_type']; ?>
                            </p>
                        ...
                        <div class="block2-txt-child2 flex-r p-t-3">
                            <a href="../Admin/public/addWishlist.php?p_id=<?php echo $product['p_id']; ?>"
                                ...
                                <img class="icon-heart2 dis-block trans-04 ab-t-l" src="images/icons/icon-heart-02.png"
                                    alt="ICON" href="../Admin/public/addWishlist.php?p_id=<?php echo $product['p_id']; ?>">
                            </a>
                        </div>
                    </div>
                </form>
